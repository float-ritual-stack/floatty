 ...
 *
 * Embeds the claude-mem worker's built-in viewer UI (localhost:37777)
 ...
 *
 * Compile: node scripts/compile-door.mjs doors/claude-mem/claude-mem.tsx ~/.floatty-dev/doors/claude-mem/index.js
 */
...
function ClaudeMemView(props: DoorViewProps<MemData | null>) {
  ...
  const url = () => (props.settings?.url as string) || 'http://localhost:37777';
...
export const door = {
  ...
  async execute(
    ...
    const url = (ctx.settings?.url as string) || 'http://localhost:37777';
